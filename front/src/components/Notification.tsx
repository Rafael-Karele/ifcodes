...
export default function Notification({
    ...
    return (
        <div
            className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 ${typeStyles[type]} px-6 py-3 rounded shadow-lg flex flex-col items-center gap-2 z-[100] max-w-[350px] w-[calc(100vw-2rem)]`}
        >
            {onClose && (
                <button
